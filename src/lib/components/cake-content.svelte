...
{#if cake.style == Style.Inset}
	...
	{#if cake.midSection}
		<rect class="mid-section" x="44" y="137" width="241" height="5" style="fill:{cake.corpus}; fill:url({corpusUrl});" />
	{/if}
{:else}
	<path
		class="bg"
	...
	{#if isNotEmpty(cake.filling)}
		<rect class="filling-bottom" x="38" y="140" width="250" height="42" style="fill:{cake.filling}; fill:url({fillingUrl});" />
	{/if}
	...
	{#if cake.midSection}
		<rect class="mid-section" x="38" y="137" width="247" height="5" style="fill:{cake.corpus}; fill:url({corpusUrl});" />
	{/if}
{/if}

<path
	id="corpus"
	style="fill:{cake.corpus};fill:url({corpusUrl});"
